          ...
          <div className="footer-section brand-section">
            <div className="footer-logo">
              ...
              <span className="footer-tagline">
                Rèn luyện não bộ thông minh
              </span>
            </div>
            <p className="brand-description">
              Nền tảng trò chơi trí não hàng đầu Việt Nam, giúp bạn rèn luyện tư
              duy và cải thiện trí nhớ mỗi ngày.
            </p>
            <div className="footer-social-links">
              <a
                href="https://www.facebook.com/park.wangank/"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/quanganhmasterd/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.youtube.com/@quanganhbach4567"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="footer-section">
            ...
            <div className="contact-info">
              <div className="contact-item">
                ...
                <span>bachquanganh0328@gmail.com</span>
              </div>
              <div className="contact-item">
                <FaPhoneAlt className="contact-icon" />
                <span>+84 387208025</span>
              </div>
              <div className="contact-item">
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-content">
          <div className="copyright">
            <p>
              © {new Date().getFullYear()} BrainGame. Tất cả các quyền được bảo
              lưu.
            </p>
          </div>
